...
from propiedades.views import home, listado_propiedades, detalle_propiedad, buscar_propiedades, propiedades_cercanas
...
urlpatterns = [
    ...
    path("cerca/", propiedades_cercanas, name="propiedades_cercanas"),
]
